    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <c:if test="${!empty order.assignedTruck && empty order.assignedTruck.driversIdsAndSurnames}">
                    <input type="hidden" name="maxDriversToAssign" value='${order.assignedTruck.crewSize}'>
                </c:if>
                <c:if test="${!empty order.assignedTruck && !empty order.assignedTruck.driversIdsAndSurnames}">
                    <input type="hidden" name="maxDriversToAssign" value='${order.assignedTruck.crewSize - fn:length(order.assignedTruck.driversIdsAndSurnames)}'>
                </c:if>
